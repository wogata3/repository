 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Ethan Dam");
		  toPrint += p1.toString("edam3"); // not the 903 number!
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Thomas Thole");
		  toPrint += p2.toString("tthole3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Wesley Ogata");
		  toPrint += p3.toString("wogata3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Sarah");
                  toPrint += p4.toString("sdang3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Nate");
                  toPrint += p5.toString("nhazelton6");
